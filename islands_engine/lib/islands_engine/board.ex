defmodule IslandsEngine.Board do
  ...
  @spec all_forested?(%{}) :: boolean
  defp all_forested?(board), do: Enum.all?(board, fn{_key, island} ->
    Island.forested?(island) end)
  ...
  defp overlaps_existing_island?(board, new_key, new_island) do
    Enum.any?(board, fn {key, island} when is_struct(island, Island) ->
